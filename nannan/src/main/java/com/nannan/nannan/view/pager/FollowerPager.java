...
public class FollowerPager extends BasePager implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public FollowerPager(String avUserId) {
        super();
    ...
    public View initView() {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                AVUserInfo item = (AVUserInfo) myListViewAdapter.getItem(position);
    ...
    public void initData() {
        ...
        myListViewAdapter = new MyListViewAdapter<AVUserInfo>(avUserInfos, this) {
            ...
            protected void onLoadMore(final MoreHolder moreHolder) {
                moreData = null;
                AVQuery<AVUser> followerQuery = AVUser.followerQuery(avUserId, AVUser.class);
                followerQuery.include(StringUtils.follower);
                followerQuery.orderByDescending(StringUtils.createdAt);
                followerQuery.limit(7);
                followerQuery.skip(myListViewAdapter.getDatasSize());
