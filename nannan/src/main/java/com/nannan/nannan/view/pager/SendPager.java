...
public class SendPager extends BasePager implements SwipeRefreshLayout.OnRefreshListener {

    private static MyListViewAdapter<LetterBean> myListViewAdapter;
    ...
    public SendPager(Activity activity) {
        ...
        tvOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (item.deleteReceiver){
                    ...
                    //形式
                    AVObject letterTodo = AVObject.createWithoutData(StringUtils.letterTodo, item.letterTodoId);
                    letterTodo.put(StringUtils.deleteSend, true);
    ...
    public void initData() {
        ...
        myListViewAdapter = new MyListViewAdapter<LetterBean>(letterBeens, this) {
            ...
            protected void onLoadMore(final MoreHolder moreHolder) {
                ...
                moreData = null;
                AVQuery<AVObject> query = new AVQuery<>(StringUtils.letterTodo);
                query.whereEqualTo(StringUtils.sendAVUser, UIUtils.avUser);
                query.orderByDescending(StringUtils.createdAt);
                query.limit(10);
                query.skip(myListViewAdapter.getDatasSize());
                query.include(StringUtils.receiverAVUser);
                query.findInBackground(new FindCallback<AVObject>() {
                    ...
                    public void done(List<AVObject> list, AVException e) {
                        ...
                        for (AVObject object : list) {
                            try {
                                if (object.getBoolean(StringUtils.deleteSend)){
                                    continue;
                                }
...
//                                letterBean.deleteSend = object.getBoolean(StringUtils.deleteSend);
                                ...
                                AVUser avUser = object.getAVUser(StringUtils.receiverAVUser);
